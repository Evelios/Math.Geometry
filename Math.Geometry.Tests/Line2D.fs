...
let ``Point closest to test cases`` =
    let line = Line2D.through (Point2D.meters 0. 5.) (Point2D.meters 5. 5.)
...
let ``Line Intersection`` () =
    let l1 = Line2D.through (Point2D.meters 1. 4.) (Point2D.meters 4. 1.)

    let l2 = Line2D.through (Point2D.meters 1. 1.) (Point2D.meters 4. 4.)
